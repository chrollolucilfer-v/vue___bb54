...
<div class="todo-ap">
    <div class="task-input">
        <input v-model="newTask" @keyup.enter="addTask" placeholder="Add New Task">  <!-- v-model is two way bindign variable which tells where to store a value in what varaible  -->
